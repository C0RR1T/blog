---
title: Decleration of AI Usage
description: How I intend to use AI for this blog
pubDate: "11 Sep 2026"
---

# Declaration of AI Usage

I think it's safe to say that programming hasn't been this challenged in years.
While AI is definitely a chance to revolutionize the way we live (and develop, for that matter),
it's also fair to say that - while AI is a great technology - it couldn't have come at a worse time.
...
But I also want to hold myself accountable and remember why I started this in the first place.

My goal for the blog is:

1. All my thoughts are my own and are written by myself
2. I can use AI to check for grammatical errors or to rewrite parts of a sentence to better adhere to the English language
3. AI is only used for debugging if I haven't found the problem via Googling
4. I won't use AI to generate images (Although admittedly, I have used AI to generate the ASCII logo)
...
If you find this and don't like it, Thanks for checking it out anyways! <br>
If you didn't find this, that's also okay.

I think we need to remind ourselves to slow down from time to time and give ourselves room to breathe.
Life is already complicated, let's not make it harder than it has to be.
